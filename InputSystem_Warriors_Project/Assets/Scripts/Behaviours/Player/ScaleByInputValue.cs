...
sealed class ScaleByInputValue : MonoBehaviour
{
    ...
    [SerializeField] InputAction _ScaleZ   = null;
    ...
    void OnEnable()
    {
        ...
        _ScaleZ.performed += ScaleZCallback;
        _ScaleZ.Enable();
    }
    ...
    void ScaleZCallback(InputAction.CallbackContext ctx)
    {
        //Vector3 vLocalScale =  Vector3.one;
        Vector3 vLocalScale =  _transform.localScale;
        vLocalScale.z = Mathf.Max(_minScale, ctx.ReadValue<float>() * _maxScale);
